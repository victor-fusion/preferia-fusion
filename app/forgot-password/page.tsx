          ...
          <div className="auth-card-body">
            {done ? (
              ...
              >
                ...
                <p style={{ fontWeight: 600, color: 'var(--feria-dark)', fontSize: '0.95rem', marginBottom: 8 }}>
                  ¡Revisa tu email!
                </p>
                <p style={{ fontSize: '0.85rem', color: 'var(--feria-muted)', lineHeight: 1.6 }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <p style={{ textAlign: 'center', fontSize: '0.85rem', color: 'var(--feria-muted)', marginTop: 4 }}>
